...
switch($_GET["op"]){
    case "insert":
        ...
        $ticket->inset_ticket($_POST["usu_id"], $_POST["cat_id"], $_POST["tick_titulo"], $_POST["tick_descrip"]);
    ...
    case "listar_x_usu":
        ...
        foreach($datos as $row){
            ...
            if($row["tick_estado"]=="Abierto"){
                $sub_array[] = '<span class="label label-pill label-warning">Abierto</span>';

            }elseif($row["tick_estado"]=="Cerrado"){
                $sub_array[] = '<span class="label label-pill label-success">Cerrado</span>';
            }else{
                $sub_array[] = '<span class="label label-pill label-default">Cancelado</span>';
            }
            $sub_array[] = date("d/m/Y H:i:s", strtotime($row["fech_crea"]));
            
            //Tabla de fecha de asignacion
            if($row["fech_asig"]==null){
                $sub_array[] = '<span class="label label-pill label-default">Sin Asignar</span>';
            }else{
                $sub_array[] = date("d/m/Y H:i:s", strtotime($row["fech_asig"]));
            }
            //Tabla de usuario asignado
    ...
    case "updatecerrar":
        $ticket->update_ticketcerrado($_POST["tick_id"]);
    break;

    case "updatecancelar":
        $ticket->update_ticketcancelado($_POST["tick_id"]);
    break;

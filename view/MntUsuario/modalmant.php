            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="usu_nom">Nombre Usuario</label>
                        <input type="texto" class="form-control" id="usu_nom" name="usu_nom"placeholder="Ingrese Nombre" required>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" for="usu_ape">Apellido Usuario</label>
                        <input type="texto" class="form-control" id="usu_ape" name="usu_ape" placeholder="Ingrese Apellido" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="usu_correo">Email Usuario</label>
                        <input type="email" class="form-control" id="usu_correo" name="usu_correo" placeholder="mail@mail.com">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="usu_pass">Contraseña Usuario</label>
